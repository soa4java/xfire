...
public abstract class GroupChatCrossDomainHelper {
    ...
    public static Map<String, DomainNodeJid> getPidAndDomainMapForAll(Set<Object> pids) {
     ...
     */
    @SuppressWarnings("unchecked")
    public static Map<String, DomainNodeJid> getPidAndDomainMapInOther(Set<String> pids) {
        ...
        try {
            ...
            Map<String, DomainNodeJid> domainMap = DomainNodeJidCacheUtils.multiFetch(new HashSet<Object>(pids));
            if (MapUtils.isEmpty(domainMap)) {
                return MapUtils.EMPTY_MAP;
            }

            Map<String, DomainNodeJid> map = new HashMap<String, DomainNodeJid>(domainMap.size());
            Iterator<String> itr = domainMap.keySet().iterator();
            String pid = null;
            DomainNodeJid domain = null;
            while (itr.hasNext()) {
                pid = itr.next();
